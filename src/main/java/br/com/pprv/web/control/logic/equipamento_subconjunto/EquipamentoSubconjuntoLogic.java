...
public class EquipamentoSubconjuntoLogic extends AbstractModuleCore{
    ...
    @EJB
    TbequipamentoSubconjuntoFacade tbequipamentoSubconjuntoFacade;

    public List<TbequipamentoSubconjunto> listTbequipamentoSubconjunto(TbequipamentoSubconjunto tbequipamentoSubconjunto) {
        return tbequipamentoSubconjuntoFacade.listTbequipamentoSubconjunto(tbequipamentoSubconjunto,super.getEM());
