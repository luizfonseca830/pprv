 ...
 */
package br.com.pprv.web.control.beans.funcionalidade;
...
import br.com.pprv.web.control.logic.acesso.AcessoLogic;
import br.com.pprv.web.control.logic.menu.MenuLogic;
import br.com.pprv.web.control.logic.modulo.ModuloLogic;
...
public class FuncionalidadeBean implements Serializable {
    ...
    public void edit() {
        ...
        if (menuLogic.editMenu(tbmenu)) {
            ...
            AbstractFacesContextUtils.addMessageError(Resources.getMessage("falhaaoalterarfuncionalidade"));
        }
    ...
    public void delete(Tbmenu tbmenu) {
        ...
        try {
            if (menuLogic.deleteMenu(tbmenu)) {
                ...
                AbstractFacesContextUtils.addMessageError(Resources.getMessage("falhaaoremoverfuncionalidade"));
            }
        } catch (Exception e) {
            AbstractFacesContextUtils.addMessageError(Resources.getMessage("falhaaoremoverfuncionalidade"));
        }
    ...
    public void create() {
        ...
        if (menuLogic.createMenu(menu)) {
            ...
            AbstractFacesContextUtils.addMessageError(Resources.getMessage("falhaaocriarfuncionalidade"));
        }
