 ...
 */
package br.com.pprv.web.control.beans.modulo;
...
public class ModuloBean {
    ...
    public void create() {
        if (moduloLogic.create(getTbmodulo())) {
            ...
            AbstractFacesContextUtils.addMessageError(Resources.getMessage("falhaaoadicionaromodulo"));
        }
    }
    ...
    public void edit() {
        if (getTbmodulo() != null) {
            if (moduloLogic.edit(getTbmodulo())) {
                ...
                AbstractFacesContextUtils.addMessageError(Resources.getMessage("falhaaoeditaromodulo"));
            }
        }
    }
    ...
    public void remove() {
        if (moduloLogic.remove(tbmodulo)) {
            ...
            AbstractFacesContextUtils.addMessageError(Resources.getMessage("falhaaoremoveomodulo"));
        }
