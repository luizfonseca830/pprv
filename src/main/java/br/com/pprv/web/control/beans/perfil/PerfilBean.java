 ...
 */
package br.com.pprv.web.control.beans.perfil;

import br.com.pprv.model.entities.Tbperfil;
import br.com.pprv.web.control.logic.perfil.PerfilLogic;
...
public class PerfilBean implements Serializable {
    ...
    public void edit() {
        ...
        if (tbperfilTmp != null) {
            AbstractFacesContextUtils.redirectPage(PagesUrl.URL_PERFIL_LIST);
            AbstractFacesContextUtils.addMessageError(Resources.getMessage("falhaaoeditarperfilperfiljaexiste"));
        } else {
    ...
    public void remove(Tbperfil tbperfil) {
        try {
            ...
            AbstractFacesContextUtils.addMessageError(Resources.getMessage("falhaaoremoverperfilperfilpodeestarsendousado"));
        }
    }
